   ...
   <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-stretch">
     ...
     <div className="relative z-10">
      ...
      >
       ...
       <p className="text-beige/40 text-lg md:text-xl font-bold italic tracking-tight mb-8">
        {t({
         id: "Merancang Solusi untuk Dampak Dunia Nyata.",
         en: "Engineering Solutions for Real-World Impact.",
        })}
       </p>
      </motion.div>
    ...
    >
     ...
     <div className="text-center relative z-20 mt-6 shrink-0">
      <p className="text-beige font-black text-xl tracking-tight leading-none uppercase">
       {profile.firstName}
      </p>
    ...
    >
     ...
     <div className="space-y-4">
      {profile.activities.map(({ prefix, highlight }) => (
       <div
        key={t(highlight)}
        className="group flex items-center gap-3 border-b border-charcoal/5 pb-3 last:border-0 last:pb-0"
       >
       ...
       <div key={t(label)} className="group">
        <p
         className={cn(
          ...
          t(label) === "Achievements" || t(label) === "Penghargaan"
           ? "text-pink-primary animate-pulse"
           : "text-charcoal group-hover:text-pink-primary",
         )}
        >
         {value}
        </p>
        <p className="text-charcoal/40 text-[9px] font-bold uppercase tracking-wider mt-1">
         {t(label)}
        </p>
       </div>
      ))}
