...
const Navbar = () => {
 ...
 return (
  <nav
   className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-beige/95 backdrop-blur-md shadow-sm" : "bg-beige/80 backdrop-blur-sm"}`}
  >
   <div className="max-w-7xl mx-auto px-6 md:px-12 h-16 flex items-center justify-between">
    {/* Logo */}
    <a
     href="#"
     className="text-green-primary font-bold text-lg tracking-tight hover:opacity-75 transition-opacity no-underline"
    >
     Portfolio Aisya
    </a>
